/*
 * Marine Compass
 * http://github.com/richtr/marinecompass
 * 
...
// +++ COMPASS +++
  ...
  window.Compass.prototype = {
    ...
    render: function() {
      ...
      // Update orientation ring buffer
...
// +++ COMPASSRENDERER +++
  ...
  CompassRenderer.prototype = {
    ...
    init: function() {
      this.setOrientation(0, 0, 0); // initialize
      ...
      this.gl.enableVertexAttribArray(0); // NORMAL
      this.gl.enableVertexAttribArray(1); // TEXCOORD
      this.gl.enableVertexAttribArray(2); // VERTEX
      ...
      //this.gl.uniform3f(this.gl.getUniformLocation(this.shaderProgram, "lightDir"), 0, 0, 1);
  ...
  Turntable.prototype = {
    ...
    buildCapObject: function() {
      ...
      var h=dy-rh;
  		...
  		var colors = new Array( vertices.length / 3 * 4 );
  		var c1 = 0, c2 = 0;
      ...
      this.mCapColorBufferGL = this.gl.createBuffer();
      this.gl.bindBuffer(this.gl.ARRAY_BUFFER, this.mCapColorBufferGL);
      this.gl.bufferData(this.gl.ARRAY_BUFFER, new Float32Array( colors ), this.gl.STATIC_DRAW);
      this.mCapColorBufferGL.itemSize = 4;
      this.mCapColorBufferGL.numItems = colors.length / 4;
    ...
    draw: function() {
      ...
      this.gl.enableVertexAttribArray(0); // Enable Normal
      this.gl.enableVertexAttribArray(1); // Enable TexCoords
      ...
      this.gl.disableVertexAttribArray(0); // Disable Normal
  		this.gl.disableVertexAttribArray(1); // Diable TexCoords
      
      /*this.gl.bindBuffer(this.gl.ARRAY_BUFFER, this.mCapColorBufferGL);
        this.gl.vertexAttribPointer(1, this.mCapColorBufferGL.itemSize, this.gl.FLOAT, false, 0, 0);*/
